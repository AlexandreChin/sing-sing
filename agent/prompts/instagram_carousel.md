...
- watch_out     : 1 à 2 items (2 de préférence ; n'en mets qu'1 si l'article n'a qu'une vraie faille — n'en invente pas), chacun avec un `label` (court descripteur français, ex. "Source unique", "Méthodologie", "Droit de réponse", "Omission", "Rhétorique") et un `text` (≤15 mots, alerte sans citation de l'article) — (depuis guide.watch_out)
