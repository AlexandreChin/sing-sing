...
- why_selected  : DEUX courts paragraphes séparés par un saut de ligne `\n` (≤45 mots au total), NEUTRES — décris les faits, ne tranche pas. §1 : POURQUOI le sujet vaut la lecture — ses enjeux et leur diversité, au-delà de l'angle du titre (appuie-toi sur les `core_elements`). §2 : LA question de fond que l'article soulève, formulée comme une question ouverte — la MÊME tension que la question de clôture (`cta.engagement_sentence` / `root_issue`), pour que la slide 2 et la dernière slide se répondent. PAS d'éloge, PAS de verdict, PAS de critique anticipée. Ex. : « Un sujet concret et clivant dont les enjeux dépassent le bilan carbone : la faune, l'encadrement du secteur, ce que révèle l'engouement.\nAu fond, une question : le juger sur son poids climatique réel, ou sur ce qu'il symbolise ? »
