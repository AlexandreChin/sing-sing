...
- essentiel     : EXACTEMENT 3 puces, ≤15 mots chacune — **L'essentiel de l'article** (slide 2, juste après l'accroche) : un résumé NEUTRE et fidèle de ce que dit l'article, taille slide. §1 = la thèse ; §2 = l'appui/le chiffre principal ; §3 = la conclusion/recommandation de l'article. Dans la VOIX de l'article (ce qu'IL avance), AUCUNE critique, aucun « nous ». C'est un gain de temps pour le lecteur pressé + il rend l'analyse compréhensible sans lire l'original. (depuis `article_metadata.chapo`, `core_elements`, la thèse). Ex. : « Le tourisme polaire de luxe explose », « Chaque voyage émet 15-25 t de CO2, plus du double d'un Français », « L'article conclut qu'il faudrait restreindre l'activité ».
