...
`root_issue`, `steel_man`, et les points de `global_analysis`), entoure de `**…**` le ou les
...
- essentiel_summary : ≤50 mots, 1 court paragraphe — **L'essentiel de l'article** (slide 2, juste après l'accroche) : un résumé NEUTRE et fidèle de ce que dit l'article (thèse, appui/chiffre principal, conclusion). Dans la VOIX de l'article (ce qu'IL avance), AUCUNE critique, aucun « nous ». Mets en gras `**…**` les 2–3 mots/chiffres décisifs. Gain de temps pour le lecteur pressé, et rend l'analyse compréhensible sans lire l'original. (depuis `article_metadata.chapo`, `core_elements`, la thèse). Ex. : « Reporterre décrit l'**essor du tourisme polaire de luxe** : chaque voyage émettrait **15 à 25 t** de CO2 par passager et menacerait la faune. Sa thèse — ces touristes **détruisent les paysages qu'ils viennent admirer** — le conduit à réclamer de **restreindre** l'activité. »
